...
class Dashboard extends JFrame implements ActionListener {
    ...
    JButton withdrawBtn, depositBtn, exitBtn;
    ...
    public Dashboard() {
        ...
        JLabel head = new JLabel("ATM MAIN MENU");
        head.setFont(new Font("Arial", Font.BOLD, 24));
        head.setBounds(150, 40, 300, 40);
        add(head);

        withdrawBtn = new JButton("Withdraw");
        withdrawBtn.setBounds(170, 120, 150, 35);
        withdrawBtn.addActionListener(this);
        add(withdrawBtn);

        depositBtn = new JButton("Deposit");
        depositBtn.setBounds(170, 180, 150, 35);
        depositBtn.addActionListener(this);
        add(depositBtn);

        exitBtn = new JButton("Exit");
        exitBtn.setBounds(170, 240, 150, 35);
...
class Deposit extends JFrame implements ActionListener {
    ...
    public Deposit() {
        ...
        confirmBtn.setBounds(70,160,120,30);
        confirmBtn.addActionListener(this);
        add(confirmBtn);

        backBtn = new JButton("Back");
        backBtn.setBounds(210,160,120,30);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == confirmBtn){
            ...
            if(amount.isEmpty()){
                ...
                JOptionPane.showMessageDialog(this,"Deposit Successful: " + amount + " taka");
                new Dashboard();
                this.setVisible(false);
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == confirmBtn){
            ...
            if(amount.isEmpty()){
                ...
                JOptionPane.showMessageDialog(this,"Withdraw Successful: " + amount + " taka");
                new Dashboard();
                this.setVisible(false);
            }
        }
